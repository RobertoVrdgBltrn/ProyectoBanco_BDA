 ...
 * @author labcisco
 */
public class TransferenciasNuevoDTO {
    ...
    public TransferenciasNuevoDTO() {
    }

    public TransferenciasNuevoDTO(int id_Operacion, int id_CuentaOrige, int id_CuentaDestino) {
        this.id_Operacion = id_Operacion;
        this.id_CuentaOrige = id_CuentaOrige;
        this.id_CuentaDestino = id_CuentaDestino;
    }

    public TransferenciasNuevoDTO(int id, int id_Operacion, int id_CuentaOrige, int id_CuentaDestino) {
        this.id = id;
        this.id_Operacion = id_Operacion;
        this.id_CuentaOrige = id_CuentaOrige;
        this.id_CuentaDestino = id_CuentaDestino;
    ...
    public String toString() {
        return "TransferenciasNuevoDTO{" + "id=" + id + ", id_Operacion=" + id_Operacion + ", id_CuentaOrige=" + id_CuentaOrige + ", id_CuentaDestino=" + id_CuentaDestino + '}';
    }
